  ...
  return (
    <>
      ...
      <motion.section
        ...
        exit={{ opacity: 0, y: 10 }}
        className="flex flex-col border max-w-[1000px] w-full bg-white rounded-lg gap-10 items-center md:px-5 px-36 py-12 justify-center"
      >
        ...
        {quiz.highScore > 0 && (
          <p className="text-sm self-start">
           Current High Score: <span className="font-bold">{quiz.highScore}</span> 
          </p>
        )}
        ...
        <h1 className="text-gray-500 text-sm">
          <i>
            Note this is the work of <b>Einstein Tech PLC</b>, cloning is not allowed 
          </i>
        </h1>
      </motion.section>
    </>
